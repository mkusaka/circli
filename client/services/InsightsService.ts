...
export class InsightsService {
   ...
   * @returns any An array of timeseries data, one entry per workflow.
   * @throws ApiError
   */
  public static getWorkflowTimeseries({
    projectSlug,
    branch,
    allBranches,
    ...
    return __request(OpenAPI, {
      method: 'GET',
      url: '/insights/time-series/{project-slug}/workflows',
      path: {
        'project-slug': projectSlug,
      },
      query: {
   ...
   * @returns any A paginated list of recent job runs
   * @throws ApiError
   */
  public static getProjectJobRuns({
    projectSlug,
    workflowName,
    jobName,
    branch,
    ...
    items: Array<{
       ...
       * Job status.
       */
      status: 'success' | 'not_run' | 'failed' | 'canceled' | 'unauthorized';
      /**
       * The duration in seconds of a run.
       */
      duration: number;
    ...
    return __request(OpenAPI, {
      method: 'GET',
      url: '/insights/{project-slug}/workflows/{workflow-name}/jobs/{job-name}',
      path: {
        'project-slug': projectSlug,
        'workflow-name': workflowName,
        'job-name': jobName,
